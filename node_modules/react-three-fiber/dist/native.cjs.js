...
var useCanvas = function useCanvas(props) {
  ...
  var IsReady = React.useCallback(function (_ref) {
  ...
  var prepareRay = React.useCallback(function (event) {
    if (event.clientX !== void 0) {
      ...
      var mouseX = (event.clientX - left) / (right - left) * 2 - 1;
      var mouseY = -((event.clientY - top) / (bottom - top)) * 2 + 1;
      ...
      if (handlers.pointerOver || handlers.pointerOut) {
        ...
        if (!hoveredItem) {
          ...
          Array.from(hovered.values()).forEach(function (data) {
            ...
            if (checkId !== id) {
              var _handlers = data.object.__handlers;
              if (_handlers && _handlers.pointerOut) _handlers.pointerOut(_extends({}, data, {
                type: 'pointerout'
              }));
...
function useRender(fn, takeOverRenderloop, deps) {
  ...
  React.useEffect(function () {
    return void console.warn('react-three-fiber: Please use useFrame(fn, [priority=0]) ✅ instead of useRender ❌, the former will be made obsolete soon!');
  }, []);
...
function useLoader(Proto, url, extensions) {
  ...
  var _usePromise = usePromise(function (Proto, url) {
    return new Promise(function (res) {
      ...
      objects = _usePromise.objects; // Dispose objects on unmount


  React.useEffect(function () {
    return function () {
      return data.scene && data.scene.dispose();
    };
...
var IsReady = React.memo(function (_ref) {
  ...
  var _useCanvas = useCanvas(_extends({}, props, {
    gl: gl
  })),
  ...
  var panResponder = React.useMemo(function () {
    return reactNative.PanResponder.create({
      ...
      onPanResponderMove: function onPanResponderMove(e) {
        return pointerEvents.onPointerMove(clientXY(e));
      },
      ...
      onPanResponderRelease: function onPanResponderRelease(e) {
        return pointerEvents.onPointerLeave(clientXY(e));
      },
      onPanResponderTerminate: function onPanResponderTerminate(e) {
        return pointerEvents.onLostPointerCapture(clientXY(e));
      },
